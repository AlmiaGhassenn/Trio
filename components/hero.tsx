    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="text-center">
          ...
          >
            <div className="text-center">
              ...
              <div className="mt-1 text-sm text-muted-foreground">{t.hero.statsProjects}</div>
            </div>
            <div className="text-center">
              <div className="font-[var(--font-syne)] text-3xl md:text-4xl font-bold text-foreground">
                <Counter end={98} suffix="%" />
              </div>
              <div className="mt-1 text-sm text-muted-foreground">{t.hero.statsSatisfaction}</div>
            </div>
            <div className="text-center">
              <div className="font-[var(--font-syne)] text-3xl md:text-4xl font-bold text-foreground">
                <Counter end={3} />
              </div>
              <div className="mt-1 text-sm text-muted-foreground">{t.hero.statsCountries}</div>
            </div>
          </motion.div>
        </div>
      </div>
      ...
      >
        <div className="flex flex-col items-center gap-2">
          <span className="mt-3 text-xs text-muted-foreground">{t.hero.scroll}</span>
          <motion.div
            animate={{ y: [0, 8, 0] }}
